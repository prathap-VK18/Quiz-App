...
public class nmqn2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mi2=mi1+mi2;
                Intent i=new Intent(nmqn2.this, res2.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.h: {
                Intent i = new Intent(nmqn2.this, MainActivity.class);
                startActivity(i);
                return true;
            }
            ...
            case R.id.r: {
                ...
                Intent i = new Intent(nmqn2.this, mq1.class);
                startActivity(i);
                return true;
